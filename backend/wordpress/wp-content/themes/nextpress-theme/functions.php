...
// Redirect any attempts to access the comments page
...
// Remove comments link from admin bar new content menu
function disable_comments_new_content_admin_bar( $wp_admin_bar ) {
    $wp_admin_bar->remove_node( 'comments' );
}
add_action( 'admin_bar_menu', 'disable_comments_new_content_admin_bar', 999 );
