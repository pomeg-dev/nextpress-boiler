...
module.exports = {
	...
	// NOTE (tw4 spike): the col-* utilities previously generated by a JS plugin
	// are now produced from the `--spacing-col-*` theme vars in globals.css.
	// The v4 spacing namespace feeds w-/min-w-/max-w-/gap-/m*-/p*-col-N in one go.
	plugins: [],
};
